...
class TogglDetailedApiHandler_Tests(unittest.TestCase):
    def test_handle_with_several_entries(self):
        entries = [
            {
                "description": "Meeting",
                "start": "2004-02-04T09:15:41-05:00",
                "dur": 557000,
                "client": "client 1",
                "project": "project 1"
            },
            {
                "description": "Email",
                "start": "2004-02-04T09:24:58-05:00",
                "dur": 398000,
                "client": "client 1",
                "project": "project 1"
            },
            {
                ...
                "start": "2004-02-04T09:31:43-05:00",
                "dur": 4755000,
                "client": "client 1",
                "project": "project 3"
            },
            {
                ...
                "start": "2004-02-04T10:50:45-05:00",
                "dur": 2532000,
                "client": "client 1",
                "project": "project 1"
            },
            {
                ...
                "start": "2004-02-04T11:32:58-05:00",
                "dur": 339000,
                "client": "client 1",
                "project": "project 2"
            }
        ...
        mappedEntries = TogglDetailedApiHandler(
            ...
            TogglDetailedApiMapper(DailyTimeEntryValidator())).handle("2004-02-04")

        self.assertEqual(len(mappedEntries), 5)
        self.assertEqual(mappedEntries[0].description, "Meeting")
        self.assertEqual(mappedEntries[1].date, "2004-02-04")
